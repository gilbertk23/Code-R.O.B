...
class main_menu:
    ...
    def draw_window(self):
        ...
        elif self.get_menu_state() == "play_game":
            pass

        elif self.get_menu_state() == "settings":
            pygame.Surface.fill(self.game_window, (255, 0, 0))

        elif self.get_menu_state() == "credits":
            pass
    ...
    def create_settings_button(self):
        ...
        settings_button.draw(self.game_window)
