...
class Spritesheet:
	...
	# __sprite_size = (-1, -1) # (x, y), non-mutable
	__metadata_file = "NONE" # filename.json; contains: {name for sprite after parsing, position of sprite, size of sprite} for each sprite contained in the sheet
	__data = "NONE" # JSON object contianing metadata
	__tile_size = -1
...
def main():
	spsh = Spritesheet("tile_assets/test_spritesheet.png", "tile_assets/test_metadata.json")
	spsh.parse()
