...
class main_character(character):
    ...
    # Init
    def __init__(self, sprite_sheet, window, width=CHAR_WIDTH, height=CHAR_HEIGHT, x_pos=CENTER_X, y_pos=CENTER_Y, image=DEFAULT_IMAGE, tile_map=[], health=300, speed=2, attack_range=10, attack_damage=1, player_controlled=True):
